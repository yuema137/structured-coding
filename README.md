...
Not just a place to write a plan. A process, its specifications, the prompts to run it, optional continuity hooks, and a contract for future guards.
...
| [Optional continuity hooks](structured-coding/references/continuity.md) | Compact freshness checks, snapshot attempts, and recovery instructions. Freeze and merge guards remain future work. |
...
[Want continuity hooks? See the opt-in commands and limits below.](#hooks)
